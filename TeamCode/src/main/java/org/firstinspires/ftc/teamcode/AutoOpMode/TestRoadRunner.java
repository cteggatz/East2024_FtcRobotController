...
public class TestRoadRunner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        */
        ...
        bottem.onEnd();
        */
        MotorManagerMovement bottem = new MotorManagerMovement(pivotManager, pivotMotor, 0, 2, this);
        ...
        MotorManagerMovement middle = new MotorManagerMovement(pivotManager, pivotMotor, 0.5, 2, this);
